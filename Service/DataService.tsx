...
async function AddFinalGenre(MWGId:number, genreName:string){
    let res= await fetch(`${url}/MWG/AddFinalGenre/${MWGId}/${genreName}`, {
        method: "POST",
        headers: {
            "Content-Type": "application/json"
        },
...
async function AddFinalMovieIndex(MWGId:number, FinalMovieIndex:number){
    let res= await fetch(`${url}/MWG/AddFinalMovieIndex/${MWGId}/${FinalMovieIndex}`, {
        method: "POST",
        headers: {
            "Content-Type": "application/json"
        },
...
async function EditUsername(userId:number, newUsername:string){
    let res= await fetch(`${url}/User/EditUsername/${userId}/${newUsername}`, {
        method: "POST",
        headers: {
            "Content-Type": "application/json"
        },
...
async function EditPassword(userId:number, newPassword:string){
    let res= await fetch(`${url}/User/EditPassword/${userId}/${newPassword}`, {
        method: "POST",
        headers: {
            "Content-Type": "application/json"
        },
...
async function CheckPassword(userData: ILoginDTO){
    let res= await fetch(`${url}/User/CheckPassword`, {
        method: "POST",
        headers: {
            "Content-Type": "application/json"
        },
...
async function AcceptInvitation(MWGId:number, UserId:number){
    let res= await fetch(`${url}/invitation/AcceptInvitation/${MWGId}/${UserId}`, {
        method: "POST",
        headers: {
            "Content-Type": "application/json"
        },
...
async function DeleteInvitation(MWGId:number, UserId:number){
    let res= await fetch(`${url}/invitation/DeleteInvitation/${MWGId}/${UserId}`, {
        method: "POST",
        headers: {
            "Content-Type": "application/json"
        },
...
async function GetAllUnacceptedInvitationsByUserId(UserId:number){
    let res = await fetch('https://pickflicksapi.azurewebsites.net/invitation/GetAllUnacceptedInvitationsByUserId/' + (UserId));
    if(!res.ok)
    {
        const message = `An error has occured ${res.status}`
        throw new Error(message);
